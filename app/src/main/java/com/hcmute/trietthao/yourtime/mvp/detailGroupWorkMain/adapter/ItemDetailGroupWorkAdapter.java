package com.hcmute.trietthao.yourtime.mvp.detailGroupWorkMain.adapter;
...
public class ItemDetailGroupWorkAdapter extends BaseExpandableListAdapter implements PostWorkListener {
    ...
    public ItemDetailGroupWorkAdapter(Context context, ArrayList<NhomCVModel> mListNhomCV,
                             IOnItemWorkListener itemWorkListener,IOnItemGroupWorkListener itemGroupWorkListener
    ){
